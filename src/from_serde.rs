...
use crate::types::{SGEdge, SGGraph, SGNode, SGNodeId, SGSymbol};
...
fn node_from_serde(
    ...
    return Ok((
        ...
        match kind {
            ...
            "pop_scoped_symbol" => SGNode::PopScoped(SGSymbol {
                name: get_str(node, "symbol")?.to_owned(),
                real: get_bool(node, "is_definition")?,
            }),
...
impl FromSerde for SGGraph {
    ...
    fn from_serde(value: Value) -> Result<Self::To> {
        ...
        // Resolve node ids for PushScoped
